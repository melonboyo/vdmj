...
public class Uml2vdmPluginOld extends CommandPlugin {
    
    private Hashtable<String, Element> cHash = new Hashtable<String, Element>(); 
	private List<XMIAssociationOld> asList =new ArrayList<XMIAssociationOld>();  

	public Uml2vdmPluginOld(Interpreter interpreter)
	{
		super(interpreter);
	}
	...
	{		
		for (int count = 0; count < list.getLength(); count++) 
		{
			...
			XMIAssociationOld rel = new XMIAssociationOld(rElement);
